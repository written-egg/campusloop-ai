...
const products = [
  ...
  { id: "offline-board", name: "HEAD 滑雪板", category: "运动户外", price: 500, tags: ["滑雪板"], description: "已经下架", trust: 99, status: "offline" }
];
...
const checks = {
  ...
  offlineProductExcluded: ![...snowboard.exactMatches, ...snowboard.similarRecommendations].some((item) => item.id === "offline-board")
};
